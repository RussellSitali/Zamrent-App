  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View style={{
        ...
        <Text style={{ fontSize: 20, fontWeight: "bold", marginLeft: 20 }}>Search Results</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 10 }}>
        {finalData.length === 0 ? (
          <View style={{
            ...
            <Text style={{ fontSize: 24, fontWeight: "bold", color: "#555" }}> No properties found</Text>
            <Text style={{ fontSize: 16, color: "#888", marginTop: 10, textAlign: "center" }}>
